...
window.BonziData = {
    ...
    hats: {
                ...
                gacha: {
                        common: [
                                {name: "benson", description: "A regular abgerny character named Benson."},
                                {name: "idiot", description: "Wear it proudly."},
                                {name: "monocle", description: "Fancy."},
                        ],
                        rare: [
                                {name: "headphones3", description: "Fresh beats only."},
                                {name: "headphones4", description: "Even fresher beats."},
                                {name: "blueeyes", description: "Piercing blue pupils."},
                                {name: "megavolania", description: "MEGALOVANIA intensifies."},
                                {name: "injury", description: "That looks like it hurt."},
                        ...
                        mythical: [
                                ...
                                {name: "diamondcrown", description: "Pure diamond royalty."},
                        ],
                },
                vault: [
