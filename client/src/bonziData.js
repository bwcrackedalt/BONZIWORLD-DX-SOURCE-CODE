...
window.BonziData = {
    ...
    hats: {
                ...
                gacha: [
                        {name: "benson", description: "Common. A regular abgerny character named Benson."},
                        {name: "idiot", description: "Common. Wear it proudly."},
                        {name: "monocle", description: "Common. Fancy."},
                        {name: "headphones3", description: "Rare. Fresh beats only."},
                        {name: "headphones4", description: "Rare. Even fresher beats."},
                        {name: "blueeyes", description: "Rare. Piercing blue pupils."},
                        {name: "megavolania", description: "Rare. MEGALOVANIA intensifies."},
                        {name: "injury", description: "Rare. That looks like it hurt."},
                        {name: "smile", description: "Rare. :)"},
                        {name: "longhat", description: "Epic. Very tall hat."},
                        {name: "shockedepic", description: "Epic. WHAT"},
                        {name: "dumbepic", description: "Epic. Dumb but epic."},
                        {name: "blueepic", description: "Epic. Blue epic."},
                        {name: "sphagetti", description: "Epic. Spaghetti on your hair."},
                        {name: "glitchcrown", description: "Mythical. The glitched crown of legends."},
                        {name: "diamondcrown", description: "Mythical. Pure diamond royalty."},
                ],
                vault: [
        ...
        customPfps: [
                "airplane", "astronaut", "ball", "beach", "bonzibuddy", "butterfly",
                "car", "cat", "chess", "dirtbike", "dog", "donutshop", "drip", "duck",
                "fish", "frog", "guitar", "horses", "kick", "lift-off", "miraclemachine",
                "palmtree", "pinkflower", "redflower", "skater", "snowflake",
        ],
...
event_list_joke_end:        [        [
        ...
        event_list_wtf: [
                ...
                [{type: "text", text: "shock, blood loss, infection; oh ho ho ho ho, i love stabbing. i feel tres bon!"}],
                [{type: "text", text: "tell your doctor if you have an infection! HEY! I DON'T HAVE INFECTION! LOSER! you do. Liar. I AM NOT LIAR! THAT IS SO ANNOYING! I AM FINE! you are not. YES I AM!"}],
                [{type: "text", text: "i installed windows xp on my real computer"}],
                [{type: "text", text: "i am so cool. i shit on people, add reactions that make fun of users on discord, and abuse my admin powers. i am really so cool."}],
                [{type: "text", text: "MUTED! HEY EVERYONE LOOK AT ME I SAY MUTED IN ALL CAPS WHEN I MUTE SOMEONE LMAO"}],
                [{type: "text", text: "ItzCrazyScout, No! More like.... ekfheiophjeodxenwobifuodhndoxnwsiohbdeiowdhn2werifhwefief! He banned euhdeioqwdheiwohjixzojqsioh r23oipwshnwq! End of rant."}],
                [
                ...
                [{type: "text", text: "the teacher: hey guys here going to kill a kid named 404bonzi. the kid named 404bonzi: 😱😱😱😱😱😱"}],
                [{type: "text", text: "News Good: Neathey x memjg UwU <3"}],
                [{type: "text", text: "horror nano is 9, and its true"}],
                [{type: "text", text: "ME PLANTIIIIIIIIIIIIIIII YOU NEATHEYYYYYYYYYYY"}],
                [{type: "text", text: `Good one! Problem 3, >/"=÷>#:>÷>%=%=>%=÷[[%$÷:[3=×:[[%=:[[4/2:[8÷×$'=`}],
                [{type: "text", text: "MY SUCKING"}],
                [{type: "text", text: "oh oh oh oh four! youre so good!"}],
                [{type: "text", text: "fucking"}],
                [{type: "text", text: "deviantart."}],
                [
                        {type: "text", text: "The fucking fucking AAAAAH! WHAY0T HAVE YOU DONE"},
                ],
                [{type: "text", text: "smg4 dies so im now SMG298828299928828829929838839929928828!!!!!!!!!!!!!!!!!!!!!"}],
                [{type: "text", text: "If you break your knee while hiking, most people hover it back [unrecognized]. But that makes it worse."}],
                [{type: "text", text: "gofag is my fetish"}],
                [{type: "text", text: "flipping is hard"}],
                [{type: "text", text: "i goon to 6 inflation with boobies + WHAT THE FUCK + muted + fucking problem + L + userQuery + i flood server + ENDING KIT IS A BITCH!", say: "bro i broke"}],
                [{type: "text", text: "click, click, oh oh fun clicker youre so good"}],
                [{type: "text", text: "THE GODWORD LEAK 671627627772777277277272777"}],
                [{type: "text", text: "smg4 dies, SO NOW I'M SMG67", say: "smg4 dies, so now i'm smg 6 7"}],
                [{type: "text", text: "a little mayonnaise to spice it up."}],
                [{type: "text", text: "mayonnaise",  say: "mio de noche"}],
                [{type: "text", text: "swag", say: "swahh"}],
                [{type: "text", text: "meme", say: "ime-EHH."}],
                [{type: "text", text: "BASKETBALL"}],
                [{type: "text", text: "OH GOD! I ATE TACO BELL ND IM GOING TO EXPLODE! OH, POOOOOOOOOOOOOOOOOP! I MESSED ALL THE BATHROMM!"}],
                [{type: "text", text: "fckckckc"}],
                [{type: "text", text: "i listen to kpop and i got hate"}],
                [{type: "text", text: "i mined diamonds with a wooden pickaxe"}],
                [
                        {type: "text", text: "AYAYAYAYAYAYA I AM A STEVE AND I MUST FIND A DIAMOND AND BUILD A HOUSE!"},
                        {type: "text", text: "WAWAWAWAWA I AM BUILDING A HOUSE"},
                        {type: "text", text: "WAWAWAWAWA I FOUND THE DIAMOND"},
                        {type: "html", text: "<h1>YES", say: "YES"},
                ],
                [{type: "text", text: "OH NO! I LOST ME JANITOR IN BW.KR AND I HATE DATARESETS!"}],
                [{type: "text", text: "OH NO! DEGEN LOST ME JANITOR IN BW.AKAKSKKSKKSKKSKKSKSKKDKKKDK"}],
                [{type: "text", text: "DEGEN_404BONZI, no! more like... V3FR999FE99E FR993V 9VR 9RE9 R9FE99RF299! he banned euhdeioqwdheiwohjixzojqsiohr23oipwshnwq! end of rant."}],
                ...
                [{type: "text", text: "BogenWORLD.exe has encountered and error and needs to close. Nah, seriously, you caused this error to happen because you used /wtf."}],
                ...
                [{type: "text", text: "i am a fake bia member and i got hate"}],
                [{type: "text", text: "Ronaldo 67 🤯💀🤯💀🤯"}],
                [{type: "text", text: "minus three"}],
                [{type: "text", text: "Stopp stop saying inflation"}],
                [{type: "text", text: "i am a lolcow? frickin saved"}],
                [{type: "text", text: "i did /godmode password and it didnt work"}],
                [{type: "text", text: "please make pope free"}],
                [{type: "text", text: "404bonzi smokes gas station weed and the rocks start talking to him"}],
                [{type: "text", text: "please make pope free"}],
                [{type: "text", text: "How to get blessed?"}],
                [{type: "text", text: "i am sanguche, and i miss darwin"}],
                [{type: "text", text: "happy happy bakugo + UHUHU + l + FUCKING SHIT + shit nobody cares about + muted + HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO + BURSTO IS A + 6 7 + gofag + ENDING KIT IS A BITCH + News Good: Neathey x memjg UwU <3 + HAHAHA + 8============Ð + ok i stop", say: "bro i broke"}],
                [{type: "text", text: ";;;;;;;;;;;"}],
                [{type: "text", text: "M e is going to goon to 8888888888"}],
                [{type: "text", text: "BonziWORLD.exe has encountered and error and needs to close. Nah, seriously, you caused this error to happen because you used /wtf."}],
                [{type: "text", text: "This PC cannot run Windows 11. The processor isn't supported for Windows 11. While this PC doesn't meet the system requirements, you'll keep getting Windows 10 Updates."}],
                [{type: "text", text: "i want super mario galaxy 3 now!"}],
                [{type: "text", text: "bonziworld reacts to bonziworld reacts to bonziworld reacts to..........................zzzzzzzzzzzzzzzzzzzzzzzzzz"}],
                [{type: "text", text: "who lives in a pineapple under the sea?"}],
                [{type: "text", text: "how many fucking times have i told you? GIVE ME THE MARIO 64 BETA ROM NOW NOW NOW NOW NOW NOW NOW NOW NOW NOW NOW NOW NOW NOW NOW NOW NOW NOW NOW NOW NOW NOW NOW NOW NOW NOW NOW NOW NOW NOW!"}],
                [{type: "text", text: "Another BonziWORLD is a \"bloated shitfest\""}],
...
//=====================================================
        ...
        event_list_copypasta: [
            ...
            [
                ...
                [
                        {type: "text", text: "sticky left bonziworld, and moved out of BonziCITY and then went into a hill, to go to an house."},
                        {type: "text", text: "and it was chill in the house, but one day at 9:17 in the morning, when he heard a knock on the door."},
                        {type: "text", text: "and he decided to open the door"},
